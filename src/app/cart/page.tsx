      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            >
              ...
              <div className="flex-1 min-w-0 text-center sm:text-left space-y-1">
                ...
                <Link
                  ...
                  className="block font-bold text-[#242424] hover:text-[#E8483F] truncate"
                >
                  {product.name}
                </Link>
              ...
              <div className="flex items-center gap-2 border border-neutral-200 rounded-xl p-1 bg-neutral-50">
                <button
                  ...
                  className="p-1 hover:bg-neutral-200 rounded-lg text-neutral-700 cursor-pointer"
                >
        ...
        <div className="bg-white rounded-3xl border border-neutral-200/80 p-6 shadow-xs space-y-6 sticky top-28">
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-[#E8483F] hover:bg-[#C93630] text-white font-bold text-base shadow-xl shadow-[#E8483F]/20 hover:scale-[1.02] transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
            Proceed to Checkout
