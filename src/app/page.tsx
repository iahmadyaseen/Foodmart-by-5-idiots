            ...
            <div className="flex flex-wrap items-center gap-3">
              {isAdmin && (
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-[#242424] hover:bg-neutral-800 text-white font-bold text-xs shadow-sm flex items-center gap-2 transition-all active:scale-95 cursor-pointer"
