...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Save Order to Prisma Database
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="p-5 rounded-2xl bg-neutral-50 border border-neutral-200 space-y-4 pt-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-xs font-bold text-[#E8483F] underline hover:text-[#C93630] cursor-pointer"
                  >
        ...
        <div className="bg-white rounded-3xl border border-neutral-200/80 p-6 shadow-xs space-y-6 sticky top-28">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 rounded-2xl bg-[#E8483F] hover:bg-[#C93630] text-white font-bold text-base shadow-xl shadow-[#E8483F]/20 hover:scale-[1.02] transition-all flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
          >
            {loading ? (
