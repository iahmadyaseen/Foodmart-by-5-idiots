  ...
  if (!product) {
    return (
      <div className="max-w-xl mx-auto my-20 p-8 text-center bg-white rounded-3xl border border-neutral-200">
        ...
        <Link href="/items" className="px-6 py-2.5 rounded-full bg-[#E8483F] text-white font-bold text-sm">
          Browse Catalog
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12 bg-[#FFF9F2]">
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 text-xs font-bold text-neutral-500 hover:text-[#E8483F] transition-colors"
      >
          ...
          <div className="space-y-4 pt-6 border-t border-neutral-100">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center border border-neutral-300 rounded-xl overflow-hidden bg-neutral-50">
                  <button
                    ...
                    className="p-2 text-neutral-600 hover:bg-neutral-200 transition-colors cursor-pointer"
                  >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className={`flex-1 py-3.5 px-6 rounded-2xl font-bold text-sm transition-all flex items-center justify-center gap-2 cursor-pointer ${
                  isOutOfStock
              ...
              <button
                ...
                disabled={isOutOfStock}
                className="py-3.5 px-8 rounded-2xl font-bold text-sm bg-neutral-900 text-white hover:bg-black transition-all hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                Buy Now
              </button>
            </div>
