        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2 border-t border-neutral-100">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            ...
            <select
              ...
              className="bg-[#FFF9F2] text-xs font-semibold text-[#242424] px-3 py-2 rounded-xl border border-neutral-200 focus:border-[#E8483F] focus:outline-none cursor-pointer"
            >
        ...
        {filtered.length > 0 ? (
          ...
          <div className="p-12 text-center bg-white rounded-3xl border border-neutral-200">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 rounded-full bg-[#E8483F] text-white text-xs font-bold cursor-pointer"
            >
              Reset Filters
            </button>
          </div>
