...
import { CheckCircle2, ShoppingBag, PackageCheck, ArrowRight } from 'lucide-react';
  ...
  if (!order) {
    return (
      <div className="max-w-xl mx-auto my-20 p-8 text-center bg-white rounded-3xl border border-[#F1E4D8]">
        ...
        <Link to="/" className="mt-4 inline-block px-6 py-2.5 rounded-full bg-[#E8483F] text-white font-bold text-xs">
          Return Home
        </Link>
      </div>
    );
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="text-center space-y-3 bg-emerald-50 border border-emerald-200 p-8 rounded-3xl shadow-xs">
        ...
        <p className="text-sm text-[#737373] max-w-md mx-auto">
          Thank you for choosing FOOD MART! Your order <span className="font-bold text-[#E8483F]">{order.orderId}</span> is confirmed and stored in our cloud database.
        </p>
