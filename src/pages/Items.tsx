      ...
      {query.trim() && (
        <div className="space-y-6">
          <h2 className="text-xl font-bold text-[#242424] flex items-center gap-2">
            Search Results for <span className="text-[#E8483F]">"{query}"</span>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="p-12 text-center bg-white rounded-3xl border border-neutral-200">
              <p className="text-base font-bold text-[#242424]">No products found matching "{query}"</p>
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-neutral-200/80 shadow-xs">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-[#E8483F] hover:bg-[#C93630] text-white font-bold text-xs shadow-md shadow-[#E8483F]/20 flex items-center justify-center gap-2 transition-all active:scale-95 shrink-0"
            >
