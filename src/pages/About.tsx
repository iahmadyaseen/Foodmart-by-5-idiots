    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16 bg-[#FFF9F2]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-8 rounded-3xl border border-neutral-200/80 shadow-xs space-y-4">
          ...
          <h3 className="text-xl font-bold text-[#242424]">Permanent Cloud Persistence</h3>
          <p className="text-sm text-[#737373] leading-relaxed">
            Powered by Firebase Authentication and Cloud Firestore, your account details, shopping baskets, and order transaction history are saved securely across browser reloads.
          </p>
        </div>
      </div>
